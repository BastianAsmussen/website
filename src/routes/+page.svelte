...
<main class="mx-auto p-8 my-8 max-w-4xl">
	<h1 class="text-4xl lg:text-6xl font-extrabold text-white p-5 text-center mt-20">
		Hello, my name is <span class="text-blue-500">Bastian</span>!
	</h1>
